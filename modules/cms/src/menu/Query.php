...
class Query extends Object implements QueryOperatorFieldInterface
{
     ...
     *
     * @param bool $preloadModels Whether to preload all {{luya\cms\menu\Item}} models for {{luya\cms\menu\Item::getModel}} or not.
     *
     * @return \luya\cms\menu\Query
     */
     ...
     *
     * @param int $offset Defines the amount of offset start position.
     *
     * @return \luya\cms\menu\Query
     */
     ...
     *
     * @return \luya\cms\menu\Item|bool Returns the Item object or false if nothing found.
     */
    public function one()
    {
     ...
     *
     * @return int The number of rows for your filtering options.
     */
     ...
     * @param int    $preloadModels Whether the models should be preload or not.
     *
