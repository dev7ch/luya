...
class LangSwitcher extends \luya\base\Widget
{
    ...
    /**
     * @var bool Decides whether the <ul> tag will be outputted or not
     */
    ...
    /**
     * @var callable A callable function in order to sort the (the array key of the items contains the lang short code):
     *
     * ```php
