...
class BlockController extends \luya\console\Command
{
    ...
    /**
     * @var string If type is `module` the name of the module must be provided with this property.
     */
    public $moduleName;
    ...
    /**
     * @var bool Whether the block is a container/layout block or not this will enable/dsiable the property
     */
    public $isContainer;

    /**
     * @var bool Whether the caching property should be displayed or not inside the block.
     */
    public $cacheEnabled;

    /**
     * @var bool If dry run is enabled the content of the block will be returned but no files will be created. This is usefull for unit testing.
     */
    public $dryRun = false;
