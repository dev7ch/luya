 ...
 * @property int $index Get the current index number of the block inside the current placeholder.
 * @property bool $isFirst Whether this is the first block element inside this placeholder or not.
 * @property bool $isLast Whether this is the last block element inside this placeholder or not.
 * @property int $itemsCount Returns the number of items inside this placeholder.
 * @property bool $isNextEqual Whether the next element (the element after the current element) is the same or not.
 * @property bool $isLastEqual Whether the previous element (the element before the current element) is the same or not.
 * @property int $equalIndex Get the index number within the equal elements.
