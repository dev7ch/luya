 ...
 * @property int $id The unique image identifier number.
 * @property int $fileId The file id where this image depends on.
 * @property int $filterId The applied filter id for this image
 ...
 * @property bool $fileExists Return boolean whether the file server source exsits on the server or not.
 * @property int $resolutionWidth Get the image resolution width.
 * @property int $resolutionHeight Get the image resolution height.
...
class Item extends ItemAbstract
{
     ...
     *
     * @param bool $scheme Whether the source path should be absolute or not.
     *
     * @return string|bool
     */
     ...
     *
     * @return int Get the width in Pixel.
     */
     ...
     *
     * @return int Get the height in Pixel.
     */
     ...
     *
     * @return bool|\luya\admin\image\Item Returns boolean or image item object if its found.
     */
