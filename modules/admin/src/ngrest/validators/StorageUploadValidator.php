...
class StorageUploadValidator extends Validator
{
    ...
    /**
     * @var bool Whether its possible to upload multiple files or just a single file
     */
    public $multiple = false;

    /**
     * @var int The folder id where all files will be uploaded to, this is the virtual directory number from {{luya\admin\componenets\StorageContainer}}. Defaults
    ...
    /**
     * @var bool Whether the files should be visible inside the file manager or not.
     */
