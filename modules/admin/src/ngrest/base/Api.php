...
class Api extends RestActiveController
{
    ...
    /**
     * @var bool Defines whether the automatic pagination should be enabled if more then 200 rows of data stored in this table or not.
     */
    public $autoEnablePagination = true;

    /**
     * @var int When pagination is enabled, this value is used for pagination rows by page.
     */
    public $pageSize = 100;
