 ...
 *
 * @property bool|\luya\cms\Menu $menu The menu componet if registered.
...
{
    /**
     * @var bool Pretty urls are enabled by default and can not be turned off in luya cms context.
     */
    public $enablePrettyUrl = true;

    /**
     * @var bool As mod rewrite is required by a LUYA cms instance the script name must be turned off by default.
     */
    ...
    /**
     * @var int In order to build urls, the nav item id from cms module can be stored in the UrlManager as `$contextNavItemId`.
     *
     ...
     * @param bool  $append Append to the end of the rules or not.
     */
     ...
     *
     * @return bool|\luya\cms\Menu The menu component object or false if not available.
     */
     ...
     * @param int                        $navItemId   The nav item Id
     ...
     * @param bool         $scheme Whether to use absolute scheme path or not.
     *
     * @return string The created url
     */
     ...
     * @param int                   $navItemId   The navigation item where the context url to be found.
