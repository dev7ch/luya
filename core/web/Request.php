 ...
 *
 * @property bool $isAdmin Whether the request is admin or not.
 *
...
class Request extends \yii\web\Request
{
     ...
     *
     * @param bool $state Whether its an admin request or not
     */
     ...
     *
     * @return bool If the current request is in admin context return value is true, otherwise false.
     */
