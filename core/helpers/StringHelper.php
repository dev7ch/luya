...
class StringHelper extends \yii\helpers\BaseStringHelper
{
     ...
     *
     * @return bool Whether the string starts with the wildcard marked string or not, if no wildcard symbol is contained
     ...
     *
     * @return bool Whether its a float value or not.
     */
     ...
     * @param bool         $strict   If an array of needles is provided the $strict parameter defines whether all keys must be found ($strict = true) or just one result must be found ($strict = false).
     *
     * @return bool If an array of values is provided the response may change depending on $findAll.
     */
