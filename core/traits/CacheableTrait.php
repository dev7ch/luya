...
{
    /**
     * @var bool If enabled and the cache component is available. If disabled it will fully ignore the any caching but
     *           does not throw exception.
     */
    public $cacheEnabled = true;

    /**
     * @var int Defined the duration of the caching lifetime in seconds. 3600 = 1 hour, 86400 = 24 hours. 0 is forever
     */
    public $cacheExpiration = 86400;

    /**
     * @var bool Whether the caching is enabled or disabled.
     */
    private $_cachable;
     ...
     *
     * @return bool Whether set has been success or not
     */
     ...
     *
     * @return bool Whether delete of key has been success or not
     */
     ...
     *
     * @return mixed|bool Returns the data, if not found returns false.
     */
