...
{
    /**
     * @var bool Whether the verbose printing is enabled from options parameter or not.
     */
    public $verbose = false;

    /**
     * @var bool Whether the command is in interactive mode or not, provided by option paremeters.
     */
