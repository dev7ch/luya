...
{
    /**
     * @var array|callable The executable handler to use when calling the hook event in order to generate the.
     */
    public $handler;

    /**
     * @var string The output which is generated when the is called, this is used in order to return string outputs.
     */
    public $output;

    /**
     * @var bool Whether the hook event is handled already or not.
     */
    public $isHandled = false;

    /**
     * @var bool Whether the current event is valid or not, if set to false, this event will not be triggered on output.
     */
    public $isValid = true;
